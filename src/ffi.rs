...
unsafe extern "C"{
    ...
    pub fn close(fd: i32) -> i32; // 0 on success, -1 on error
    pub fn epoll_ctl(epollfd: i32, op: i32, fd: i32, event: *mut Event) -> i32; //to interract with the epoll, register events, event struct should reflect OUR interests
